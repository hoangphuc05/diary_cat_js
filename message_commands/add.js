...
export default {
    ...
    async execute(message, args) {
        ...
        const embed = new MessageEmbed()
            ...
            .setDescription("This command is deprecating, please use the [slash command](https://support.discord.com/hc/en-us/articles/1500000368501-Slash-Commands-FAQ) `add` instead");
